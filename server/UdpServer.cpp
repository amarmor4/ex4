...
***********************************************************************/
UdpServer::UdpServer(bool isServers, int port_num) {
...
***********************************************************************/
int UdpServer::sendData(string data) {
...
***********************************************************************/
int UdpServer::reciveData(char* buffer, int size) {
	struct sockaddr_in to;
	unsigned int to_len = sizeof(struct sockaddr_in);
	//receive
    int bytes = recvfrom(this->socketDescriptor, buffer, sizeof(buffer), 0,
